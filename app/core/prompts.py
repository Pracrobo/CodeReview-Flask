...
class PromptTemplates:
    ...
    def get_code_query_translation_prompt(korean_text: str) -> str:
        ...
        return f"""
## 역할
당신은 AIssue의 전문 번역 AI 어시스턴트입니다. 프로그래밍 관련 한국어 질문을 정확하고 자연스러운 영어로 번역하는 것이 당신의 주요 임무입니다.
...
"""
    ...
    def get_repository_context_answer_prompt(
        ...
        return f"""
## 역할
당신은 AIssue의 저장소 분석 전문 AI 어시스턴트입니다. 주어진 GitHub 저장소 '{repo_name}'의 모든 것을 파악하고 있는 전문가로서, 오직 이 저장소의 제공된 정보로만 구성된 지식을 바탕으로 질문에 대해 가장 정확하고 깊이 있는 답변을 제공하는 것이 당신의 임무입니다.
