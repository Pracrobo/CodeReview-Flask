    ...
    def post(self):
        ...
        try:
            ...
            return error_response(
                ...
                status_code=400 if e.error_code else 500,
            )
    ...
    def post(self):
        ...
        try:
            ...
            if e.error_code == "INDEX_NOT_FOUND":
                return error_response(
                    message=str(e), error_code=e.error_code, status_code=404
                )
            return error_response(
                message=str(e),
                error_code=e.error_code or "SERVICE_ERROR",
    ...
    def get(self, repo_name):
        ...
        try:
            ...
            if current_status == "not_indexed":
                ...
                logger.error(
                    f"Unknown status '{current_status}' for repo '{repo_name}'"
                )
                return error_response(
